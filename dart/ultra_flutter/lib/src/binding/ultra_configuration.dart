...
import 'package:ultra_flutter/src/services/log_collector.dart';
...
class UltraConfiguration {
  const UltraConfiguration({
  ...
  ///   UltraConfiguration(logCollector: LoggingLogCollector()),
  /// );
  /// ```
  ///
  ...
  /// UltraFlutterBinding.ensureInitialized(
  ///   UltraConfiguration(logCollector: collector),
  /// );
