...
///
/// Only extensions registered via [registerUltraExtension] are tracked
/// here. Internal extensions registered by [UltraFlutterBinding] are excluded.
...
/// [UltraExtensionResult] which is pattern-matched to produce the
...
void registerUltraExtension({
  ...
  registerInternalUltraExtension(name: name, callback: callback);
}
